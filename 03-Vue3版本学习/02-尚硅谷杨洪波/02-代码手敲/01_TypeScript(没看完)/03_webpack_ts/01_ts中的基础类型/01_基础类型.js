/*
 * @Author: liming
 * @Date: 2021-07-12 15:51:54
 * @LastEditTime: 2021-07-12 17:29:30
 * @FilePath: \LearnVue\03-Vue3版本学习\02-尚硅谷杨洪波\02-代码手敲\01_TypeScript\03_webpack_ts\src\01_基础类型.ts
 */
//基础类型
// 布尔类型  ----->boolean
// 基本语法
...
(function () {
    ...
    // 把严格模式改成false后编译就不会报错了，否则报错说Type 'undefined' is not assignable to type 'number'
    //   console.log(num2);
    console.log("==================");
    // 数组类型
    // 数组定义方式1
